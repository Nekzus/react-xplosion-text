...
var styles = {
  blueColor: "Xplosion-module_blueColor__jeMVz",
  greenColor: "Xplosion-module_greenColor__Y95Tt",
  pinkColor: "Xplosion-module_pinkColor__b-Du4",
  orangeColor: "Xplosion-module_orangeColor__AXZwD",
  darkColor: "Xplosion-module_darkColor__YzJyb",
  lightColor: "Xplosion-module_lightColor__bjp1k",
  word: "Xplosion-module_word__QV2nl",
  fancy: "Xplosion-module_fancy__2Onv9",
  outer: "Xplosion-module_outer__nd-8v",
  inner: "Xplosion-module_inner__6l-io",
  float: "Xplosion-module_float__fjOqv",
  letter: "Xplosion-module_letter__3joYp",
  "background-pan": "Xplosion-module_background-pan__m4q87",
};
...
var Xplosion = function (_a) {
  var children = _a.children,
    ...
    _b = _a.colorClassName,
    colorClassName = _b === void 0 ? "blueColor" : _b,
    style = _a.style,
    textInput = _a.textInput;
  ...
  var startAnimation = function () {
    ...
    intervalRef.current = setInterval(function () {
      ...
      if (
        iterations.every(function (iteration, lineIndex) {
          return iteration >= lines[lineIndex].length;
        })
      ) {
        if (intervalRef.current !== null) {
          clearInterval(intervalRef.current);
  ...
  return React.cloneElement(
    ...
    React.createElement(
      "div",
      { className: className, style: __assign({}, style), ref: containerRef },
